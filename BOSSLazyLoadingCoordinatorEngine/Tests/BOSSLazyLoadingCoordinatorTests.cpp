...
TEST_CASE("EvaluateInEnginesTest", "[]") { // NOLINT
  ...
  enginePaths.push_back(
      "/enter/path/to/BOSSConditionalEvaluationEngine/"
      "build/libBOSSConditionalEvaluationEngine.so");
  enginePaths.push_back(RBL_PATH);
  enginePaths.push_back("/enter/path/to/"
                        "BOSSVeloxEngine/build/libBOSSVeloxEngine.so");
  enginePaths.push_back(
  ...
  newArgs.emplace_back(std::move(queryMap.at("STAGED_RANGED_SELECT_BOSS")()));
