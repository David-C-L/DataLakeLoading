...
namespace dads::benchmarks::LazyLoading::utilities {

using namespace std;
using namespace dads;
  using dads::utilities::operator""_; // NOLINT(misc-unused-using-decls) clang-tidy bug
using dads::benchmarks::LazyLoading::config::paths::IN_MEM_CONV_CSV_SIZE_PATH;
using dads::benchmarks::LazyLoading::config::paths::IN_MEM_CONV_CSV_TIME_PATH;
using dads::benchmarks::LazyLoading::config::paths::OVERHEAD_CSV_SIZE_PATH;
using dads::benchmarks::LazyLoading::config::paths::OVERHEAD_CSV_TIME_PATH;
using dads::benchmarks::LazyLoading::config::paths::
    QUERY_OVERHEAD_CSV_SIZE_PATH;
using dads::benchmarks::LazyLoading::config::paths::
    QUERY_OVERHEAD_CSV_TIME_PATH;

inline void writeOverheadData(dads::ComplexExpression &&e, double selectivity) {
  ...
  auto extractSizeAsCSV = [&](dads::ComplexExpression &&sizeExpr) {
    auto [sizeHead, sizeUnused_, sizeDynamics, sizeSpans] =
        std::move(sizeExpr).decompose();
    std::ostringstream data;
    data << doubleToString(selectivity) << ",";
    data << std::get<int64_t>(std::get<dads::ComplexExpression>(sizeDynamics[0])
                                  .getDynamicArguments()[0])
         << ",";
    data << std::get<int64_t>(std::get<dads::ComplexExpression>(sizeDynamics[1])
                                  .getDynamicArguments()[0])
         << ",";
    data << std::get<int64_t>(std::get<dads::ComplexExpression>(sizeDynamics[2])
                                  .getDynamicArguments()[0])
         << ",";
    data << std::get<int64_t>(std::get<dads::ComplexExpression>(sizeDynamics[3])
                                  .getDynamicArguments()[0])
         << "\n";
  ...
  auto extractTimeAsCSV = [&](dads::ComplexExpression &&timeExpr) {
    auto [timeHead, timeUnused_, timeDynamics, timeSpans] =
        std::move(timeExpr).decompose();
    std::ostringstream data;
    data << doubleToString(selectivity) << ",";
    data << std::get<int64_t>(std::get<dads::ComplexExpression>(timeDynamics[0])
                                  .getDynamicArguments()[0])
         << ",";
    data << std::get<int64_t>(std::get<dads::ComplexExpression>(timeDynamics[1])
                                  .getDynamicArguments()[0])
         << "\n";
  ...
  if (overheadSizeFile.is_open() && overheadTimeFile.is_open()) {
    ...
    overheadSizeFile << extractSizeAsCSV(
        std::move(std::get<dads::ComplexExpression>(dynamics[0])));
    overheadTimeFile << extractTimeAsCSV(
        std::move(std::get<dads::ComplexExpression>(dynamics[1])));
...
inline void writeInMemConvergenceData(dads::ComplexExpression &&e,
                                      int64_t numQueries,
...
inline void writeOverheadQueryData(dads::ComplexExpression &&e,
                                   int64_t systemKey) {
  auto [head, unused_, dynamics, spans] = std::move(e).decompose();
  auto extractSizeAsCSV = [&](dads::ComplexExpression &&sizeExpr) {
    auto [sizeHead, sizeUnused_, sizeDynamics, sizeSpans] =
  ...
  inline void writeCURLData(dads::ComplexExpression &&e,
  ...
  auto extractSizeAsCSV = [&](dads::ComplexExpression &&sizeExpr) {
    ...
    data << std::get<int64_t>(std::get<dads::ComplexExpression>(sizeDynamics[3])
                                  .getDynamicArguments()[0])
         << ",";
    data << std::get<int64_t>(std::get<dads::ComplexExpression>(sizeDynamics[4])
                                  .getDynamicArguments()[0])
         << "\n";
  ...
  inline dads::Expression wrapEval(dads::Expression &&expression, int32_t equalityRhs) {
