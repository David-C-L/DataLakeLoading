...
namespace dads::benchmarks::LazyLoading::MiniseedQueries {
...
inline std::vector<std::function<dads::Expression()>> dadsQueries{
    [] {
...
inline std::vector<std::function<dads::Expression()>> dadsRangesQueries{
    [] {
      auto filesGather =
    ...
    [] {
      ...
      auto rangeTable = "Table"_(
          "start"_("List"_(
              std::move(dads::Span<int64_t const>(std::move(vector(starts)))))),
          "end"_("List"_(
              std::move(dads::Span<int64_t const>(std::move(vector(ends)))))));
      auto dataRangesGather = "GatherRanges"_(
  ...
  inline std::vector<std::function<dads::Expression()>> dadsCycleRangesQueries{
    [] {
      auto filesGather =
...
inline std::vector<std::function<dads::Expression()>> dataVaultsQueries{
    [] {
